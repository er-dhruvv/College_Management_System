...
const NavBarFaculty = () => {
  ...
  const menuItems = [
    ...
    { name: "Profile", icon: faUser, path: "/ProfileFaculty" },
    { name: "Students", icon: faGraduationCap, path: "/StudentsRoute" },
    { name: "Add Marks", icon: faChartBar, path: "/AddMarks" },
    { name: "Attendance", icon: faCalendarCheck, path: "/FillAttendance" },
    { name: "Leave Requests", icon: faFileLines, path: "/LeaveDataFaculty" },
  ];
